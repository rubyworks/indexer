module Metadata
  ...
  class Builder
    ...
    # It is not the recommended that a .gemspec be the usual source of a metaspec.
    # Rather it is highly recommended that a the gemspec be produced from
    # the .meta instead. Nonetheless, this can serve as a temporary measure
    # for creating a .meta file until the .meta is used as the primary metadata
    # file.
    #
    module GemspecBuild
      #
